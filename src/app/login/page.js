...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    scriptTelegram.src = "https://telegram.org/js/telegram-widget.js?15";
    scriptTelegram.async = true;
    scriptTelegram.setAttribute("data-telegram-login", "MitFooduzBot");
    scriptTelegram.setAttribute("data-size", "medium");
    scriptTelegram.setAttribute("data-onauth", "onTelegramAuth(user)");
    scriptTelegram.setAttribute("data-request-access", "write");
    scriptTelegram.onload = () => console.log("Telegram Widget скрипт загружен");
    scriptTelegram.onerror = () => console.error("Ошибка загрузки Telegram Widget скрипта");
    ...
    if (container) {
      ...
      widgetContainer.appendChild(scriptTelegram);
